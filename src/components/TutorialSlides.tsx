...
const st = StyleSheet.create({
  container: { flex: 1 },
  slide: { alignItems: 'center', paddingHorizontal: 28, paddingTop: 12, paddingBottom: 32 },
  ...
  iconTxt: { fontSize: 32 },
  slideTitle: { fontSize: 21, fontWeight: '800', color: '#1A3057', textAlign: 'center', marginBottom: 10 },
  slideBody: { fontSize: 14, color: '#374151', textAlign: 'center', lineHeight: 21, marginBottom: 16 },
  bulletList: { alignSelf: 'stretch', gap: 8 },
  bulletRow: { backgroundColor: '#F9FAFB', borderRadius: 12, padding: 11, borderLeftWidth: 3, borderLeftColor: '#D4822A' },
  bulletTxt: { fontSize: 13, color: '#1F2937', lineHeight: 19 },
